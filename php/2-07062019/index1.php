...
<html>
  ...
  <body>
      ...
      <?php $data1 = array ("Name", "Email", "Phone", "Dob","Country","City"); ?>
      <table class="table">
      <thead class="thead-dark text-center"> 
      <tr> <?php for ($i =0; $i < count($data1); $i++) {  ?>
      <th> <?php echo $data1[$i] ?>
      </th>
     <?php }  ?>
      </tr>
      ...
      <tbody>
      <?php for ($y = 0; $y <count($data999);$y ++) { ?>
      <tr> 
      <td><?php echo $data999[$y]['name'] ?></td>
      <td><?php echo $data999[$y]['email'] ?></td>
      <td><?php echo $data999[$y]['phone'] ?></td>
      <td><?php echo $data999[$y]['dob'] ?></td>
      <td><?php echo $data999[$y]['country'] ?></td>
      <td><?php echo $data999[$y]['city'] ?></td>
